...
class ResUNetExpanded(ME.MinkowskiNetwork):
  NORM_TYPE = None
  BLOCK_NORM_TYPE = 'BN'
  CHANNELS = [None, 32, 64, 128, 256]
  TR_CHANNELS = [None, 32, 64, 64, 128]
  ...
  def __init__(self,
    ...
    self.conv1 = ME.MinkowskiConvolution(
        ...
        dimension=D)
    self.norm1 = get_norm(NORM_TYPE, CHANNELS[1], bn_momentum=bn_momentum, D=D)
    self.norm1_2 = get_norm(NORM_TYPE, CHANNELS[1], bn_momentum=bn_momentum, D=D)

    self.block1 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[1], CHANNELS[1], bn_momentum=bn_momentum, D=D)
    self.block1_2 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[1], CHANNELS[1], bn_momentum=bn_momentum, D=D)
    ...
    self.conv2 = ME.MinkowskiConvolution(
        ...
        dimension=D)
    self.norm2 = get_norm(NORM_TYPE, CHANNELS[2], bn_momentum=bn_momentum, D=D)
    self.norm2_2 = get_norm(NORM_TYPE, CHANNELS[2], bn_momentum=bn_momentum, D=D)

    self.block2 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[2], CHANNELS[2], bn_momentum=bn_momentum, D=D)
    self.block2_2 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[2], CHANNELS[2], bn_momentum=bn_momentum, D=D)
    ...
    self.conv3 = ME.MinkowskiConvolution(
        ...
        dimension=D)
    self.norm3 = get_norm(NORM_TYPE, CHANNELS[3], bn_momentum=bn_momentum, D=D)
    self.norm3_2 = get_norm(NORM_TYPE, CHANNELS[3], bn_momentum=bn_momentum, D=D)

    self.block3 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[3], CHANNELS[3], bn_momentum=bn_momentum, D=D)
    self.block3_2 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[3], CHANNELS[3], bn_momentum=bn_momentum, D=D)
    ...
    self.conv4 = ME.MinkowskiConvolution(
        ...
        dimension=D)
    self.norm4 = get_norm(NORM_TYPE, CHANNELS[4], bn_momentum=bn_momentum, D=D)
    self.norm4_2 = get_norm(NORM_TYPE, CHANNELS[4], bn_momentum=bn_momentum, D=D)

    self.block4 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[4], CHANNELS[4], bn_momentum=bn_momentum, D=D)
    self.block4_2 = get_block(
        BLOCK_NORM_TYPE, CHANNELS[4], CHANNELS[4], bn_momentum=bn_momentum, D=D)
    ...
    self.conv4_tr = ME.MinkowskiConvolutionTranspose(
        ...
        dimension=D)
    self.norm4_tr = get_norm(NORM_TYPE, TR_CHANNELS[4], bn_momentum=bn_momentum, D=D)
    self.norm4_tr_2 = get_norm(NORM_TYPE, TR_CHANNELS[4], bn_momentum=bn_momentum, D=D)

    self.block4_tr = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[4], TR_CHANNELS[4], bn_momentum=bn_momentum, D=D)
    self.block4_tr_2 = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[4], TR_CHANNELS[4], bn_momentum=bn_momentum, D=D)
    ...
    self.conv3_tr = ME.MinkowskiConvolutionTranspose(
        ...
        dimension=D)
    self.norm3_tr = get_norm(NORM_TYPE, TR_CHANNELS[3], bn_momentum=bn_momentum, D=D)
    self.norm3_tr_2 = get_norm(NORM_TYPE, TR_CHANNELS[3], bn_momentum=bn_momentum, D=D)

    self.block3_tr = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[3], TR_CHANNELS[3], bn_momentum=bn_momentum, D=D)
    self.block3_tr_2 = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[3], TR_CHANNELS[3], bn_momentum=bn_momentum, D=D)
    ...
    self.conv2_tr = ME.MinkowskiConvolutionTranspose(
        ...
        dimension=D)
    self.norm2_tr = get_norm(NORM_TYPE, TR_CHANNELS[2], bn_momentum=bn_momentum, D=D)
    self.norm2_tr_2 = get_norm(NORM_TYPE, TR_CHANNELS[2], bn_momentum=bn_momentum, D=D)

    self.block2_tr = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[2], TR_CHANNELS[2], bn_momentum=bn_momentum, D=D)
    self.block2_tr_2 = get_block(
        BLOCK_NORM_TYPE, TR_CHANNELS[2], TR_CHANNELS[2], bn_momentum=bn_momentum, D=D)
  ...
  def forward(self, x):
    ...
    out_s1 = self.norm1_2(out_s1)
    out_s1 = self.block1_2(out_s1)
    out = MEF.relu(out_s1)
    ...
    out_s2 = self.norm2_2(out_s2)
    out_s2 = self.block2_2(out_s2)
    out = MEF.relu(out_s2)
    ...
    out_s4 = self.norm3_2(out_s4)
    out_s4 = self.block3_2(out_s4)
    out = MEF.relu(out_s4)
    ...
    out_s8 = self.norm4_2(out_s8)
    out_s8 = self.block4_2(out_s8)
    out = MEF.relu(out_s8)
    ...
    out = self.norm4_tr_2(out)
    out = self.block4_tr_2(out)
    out_s4_tr = MEF.relu(out)
    ...
    out = self.norm3_tr_2(out)
    out = self.block3_tr_2(out)
    out_s2_tr = MEF.relu(out)
    ...
    out = self.norm2_tr_2(out)
    out = self.block2_tr_2(out)
    out_s1_tr = MEF.relu(out)
...
class ResUNetExpBN2C(ResUNetExpanded):
  NORM_TYPE = 'BN'
  CHANNELS = [None, 32, 64, 128, 256]
  TR_CHANNELS = [None, 64, 64, 64, 128]
