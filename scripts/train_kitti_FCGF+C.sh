...
export DATASET=${DATASET:-KittiContinuousFramePairDataset}
export TRAINER=${TRAINER:-ContinuousHardestContrastiveTrainer}
...
# export WEIGHTS="./outputs/Experiments/KittiRandDistPairDataset-v0.3/HardestContrastiveLossTrainer/ResUNetBN2C/SGD-lr3e-1-e200-b8i1-modelnout32/2023-09-21_19-48-15/checkpoint.pth"
