...
export DATASET=${DATASET:-WaymoNFramePairDataset}
# export DATASET=${DATASET:-WaymoRandDistPairDataset}
export TRAINER=${TRAINER:-CorrespondenceExtensionTrainer}
...
export LABELER_DIR="./outputs/Experiments/WaymoContinuousFramePairDataset-v0.3/ContinuousCorrExtensionTrainer/ResUNetBN2C/SGD-lr3e-1-e200-b8i1-modelnout32/2023-10-12_16-55-19"
export LABELER_WEIGHT="./outputs/Experiments/WaymoContinuousFramePairDataset-v0.3/ContinuousCorrExtensionTrainer/ResUNetBN2C/SGD-lr3e-1-e200-b8i1-modelnout32/2023-10-12_16-55-19/checkpoint.pth"
