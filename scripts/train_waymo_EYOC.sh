...
export DATASET=${DATASET:-WaymoContinuousFramePairDataset}
...
# export RESUME_FILE="./outputs/Experiments/WaymoContinuousFramePairDataset-v0.3/ContinuousCorrExtensionTrainer/ResUNetBN2C/SGD-lr3e-1-e200-b8i1-modelnout32/2024-03-12_14-43-55/checkpoint.pth"
# export RESUME_DIR="./outputs/Experiments/WaymoContinuousFramePairDataset-v0.3/ContinuousCorrExtensionTrainer/ResUNetBN2C/SGD-lr3e-1-e200-b8i1-modelnout32/2024-03-12_14-43-55"

export WEIGHT_DIR="outputs/Experiments/pretrained/KITTI_GCL/best_val_checkpoint.pth"
