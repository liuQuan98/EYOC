...
from lib.trainer import ContrastiveLossTrainer, HardestContrastiveLossTrainer, \
    TripletLossTrainer, HardestTripletLossTrainer, CorrespondenceExtensionTrainer, \
    ContinuousCorrExtensionTrainer, ContinuousHardestContrastiveTrainer
...
def get_trainer(trainer):
  ...
  elif trainer == 'CorrespondenceExtensionTrainer':
    return CorrespondenceExtensionTrainer
  elif trainer == 'ContinuousCorrExtensionTrainer':
    return ContinuousCorrExtensionTrainer
  elif trainer == 'ContinuousHardestContrastiveTrainer':
    return ContinuousHardestContrastiveTrainer
  else:
...
if __name__ == "__main__":
  ...
  dconfig = vars(config)
  if config.resume_dir and not config.finetune_restart:
